...
public final class FrmUsuarios extends javax.swing.JInternalFrame {
    ...
    void limparCampos() {
        ...
        tipo.setSelectedItem("TIPO USUÁRIO");
        senha.setText("");
        buscar.setText("");
    ...
    private void initComponents() {
        ...
        tipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "TIPO USUÁRIO", "ADMINISTRADOR", "NORMAL" }));
        ...
        jPanel2.add(senha, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 30, 180, 30));
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        if (selecionarRegistro) {
            ...
            if (codigo.getText().equals("") || nome.getText().equals("") || sexo.getSelectedItem().equals("SEXO")
                    || tipo.getSelectedItem().equals("TIPO USUÁRIO") || sen.equals("")) {
    ...
    private void atualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_atualizarActionPerformed
        if (tabelaUsuarios.getRowCount() > 0) {
            if (tabelaUsuarios.getSelectedRowCount() > 0) {
                String sen = new String(senha.getPassword());
                if (codigo.getText().equals("") || nome.getText().equals("") || sexo.getSelectedItem().equals("SEXO")
                        || tipo.getSelectedItem().equals("TIPO USUARIO") || sen.equals("")) {
