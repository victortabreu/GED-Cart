 ...
 * @author hugov
 */
public class FrmListaAtos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "ATO", "EMOL. BRUTO", "RECOMPE MG", "EMOL. LÍQUIDO", "TFJ", "VALOR FINAL"
            }
        ) {
        ...
        buscar.setPlaceholder("CÓDIGO/ATO");
        ...
        if (tabela.getRowCount() > 0) {
            try {
                ...
                if (linha == -1) {
                    ...
                    while (!AtosSql.isNumber(quant) && quant != null) {
