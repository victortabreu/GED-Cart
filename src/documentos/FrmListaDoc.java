 ...
 * @author hugov
 */
public class FrmListaDoc extends javax.swing.JInternalFrame {
            ...
            public void itemStateChanged(ItemEvent ie) {
                if (tipo.getSelectedIndex() == 0) {
                 ...
                 if (tipo.getSelectedIndex() != 0) {
                    ...
                    DocumentosSql.listarCat(tipo.getSelectedItem().toString());
                }
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
         ...
         DocumentosSql.listarCat(buscar.getText());
